...
class DatePicker extends Component {
    ...
    show(event) {
        console.log('test');
        if(typeof this['inputDateTimePicker' + this.state.id] != 'undefined' && typeof this['calendar_' + this.state.id] != 'undefined'){
            var elInput =  this['inputDateTimePicker' + this.state.id],
                elCalendar = this['calendar_' + this.state.id]['calendarElement'],
    ...
    render() {
        ...
        return React.createElement("div", {className: "ardp-date-picker"},
            React.createElement("input",
                {
                    ref(el) {
                        self['inputDateTimePicker' + self.state.id] = el
                    },
